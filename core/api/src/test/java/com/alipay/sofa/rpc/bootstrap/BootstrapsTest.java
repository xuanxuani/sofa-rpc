...
//        providerConfigRepository.addPc(providerConfig);

//        list = providerConfigRepository.getList();
//        list.add(providerConfig);
        ProviderConfig p = list.get(0);
        System.out.println(p.getConcurrents());
        System.out.println(p.getWeight());
        System.out.println(p.getDelay());
    }
